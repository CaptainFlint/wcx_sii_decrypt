...
extern "C"
{
	...
	*/
	...
	/*-------------------------------------------------------------------------------
	  ...
	  Returns:
		...
		SIIDEC_RESULT_BUFFER_TOO_SMALL - not returned by this function
	*/
	int32_t __stdcall GetFileFormat(char* FileNameUtf8);
	...
	*/
	BOOL __stdcall IsEncryptedFile(char* FileNameUtf8);
	...
	*/
	BOOL __stdcall IsEncodedFile(char* FileNameUtf8);
	...
	*/
	#undef DecryptFile
	int32_t __stdcall DecryptFile(char* InputFileUtf8, char* OutputFileUtf8);
	...
	*/
	...
	/*-------------------------------------------------------------------------------
	  ...
	  Returns:
		...
		SIIDEC_RESULT_BUFFER_TOO_SMALL - not returned by this function
	*/
	int32_t __stdcall DecodeFile(char* InputFileUtf8, char* OutputFileUtf8);
