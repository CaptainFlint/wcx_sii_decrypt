...
extern "C"
{
	...
	*/
	  int32_t __stdcall GetMemoryFormat(void* Mem, size_t Size);
	...
	*/
	  int32_t __stdcall GetFileFormat(char* FileName);
	...
	*/
	  BOOL __stdcall IsEncryptedMemory(void* Mem, size_t Size);
	...
	*/
	  BOOL __stdcall IsEncryptedFile(char* FileName);
	...
	*/
	  BOOL __stdcall IsEncodedMemory(void* Mem, size_t Size);
	...
	*/
	  BOOL __stdcall IsEncodedFile(char* FileName);
	...
	*/
	  BOOL __stdcall Is3nKEncodedMemory(void* Mem, size_t Size);
	...
	*/
	  BOOL __stdcall Is3nKEncodedFile(char* FileName);
	...
	*/
	  int32_t __stdcall DecryptMemory(void* Input, size_t InSize, void* Output, size_t* OutSize);
	...
	*/
	#undef DecryptFile
	  int32_t __stdcall DecryptFile(char* InputFile, char* OutputFile);
	...
	/*-------------------------------------------------------------------------------
	  ...
	  larger memory use.
	*/
	  int32_t __stdcall DecryptFileInMemory(char* InputFile, char* OutputFile);
	...
	*/
	  int32_t __stdcall DecodeMemoryHelper(void* Input, size_t InSize, void* Output, size_t* OutSize, void** Helper);
	...
	*/
	  int32_t __stdcall DecodeMemory(void* Input, size_t InSize, void* Output, size_t* OutSize);
	...
	*/
	  int32_t __stdcall DecodeFile(char* InputFile, char* OutputFile);
	...
	/*-------------------------------------------------------------------------------
	  ...
	  larger memory use.
	*/
	  int32_t __stdcall DecodeFileInMemory(char* InputFile, char* OutputFile);
	...
	*/
	  int32_t __stdcall DecryptAndDecodeMemoryHelper(void* Input, size_t InSize, void* Output, size_t* OutSize, void** Helper);
	...
	*/
	  int32_t __stdcall DecryptAndDecodeMemory(void* Input, size_t InSize, void* Output, size_t* OutSize);
	...
	*/
	  int32_t __stdcall DecryptAndDecodeFile(char* InputFile, char* OutputFile);
	...
	*/
	  int32_t __stdcall DecryptAndDecodeFileInMemory(char* InputFile, char* OutputFile);
